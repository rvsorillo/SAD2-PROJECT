...
namespace WindowsFormsApp3 {
    ...
    public class Job_Order_PrintReport : ReportClass {
        
        public Job_Order_PrintReport() {
        }
        
        public override string ResourceName {
            get {
                return "Job_Order_PrintReport.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsApp3.Job_Order_PrintReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedJob_Order_PrintReport : Component, ICachedReport {
        
        public CachedJob_Order_PrintReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Job_Order_PrintReport rpt = new Job_Order_PrintReport();
            rpt.Site = this.Site;
            return rpt;
        }
